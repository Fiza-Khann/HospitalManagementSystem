<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Discharge_report1.aspx.cs" Inherits="HMS_template_Project.Discharge_report1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                        ...
                                        <ContentTemplate>
                                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="AdmissionDate" HeaderText="Admission Date" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" />
                                                    <asp:BoundField DataField="Days" HeaderText="Days" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" />
                                                    ...
                                                    <asp:BoundField DataField="Dstatus" HeaderText="Discharge Status" itemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" />
                                                    <asp:BoundField DataField="Ddate" HeaderText="Discharge Date" itemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" />
                                                    <asp:BoundField DataField="Dtime" HeaderText="Discharge Time" itemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" />
                                                </Columns>
    ...
    <script type="text/javascript">
            ...
            content: [
                ...
                },
                {
                    table: {
                        ...
                        body: [
                            ['BillNo', 'Admission Date', 'Days', 'Patient Name', 'Room Name', 'Consultant Name', 'Discharge Status', 'Discharge Date','Discharge Time'],
        ...
        function downloadPDF() {
            pdfMake.createPdf(docDefinition).download('Discharge_Report.pdf');
            closeModal();
        }
    </script>
</asp:Content>
