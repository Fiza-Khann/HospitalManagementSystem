<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="EditOP_Dental.aspx.cs" Inherits="HMS_Task1.EditOP_Dental_aspx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd">
                                <div class="panel-heading">
                                    ...
                                    <div class="mr-25">
                                        <a class="btn btn-primary" href="ViewOP_Dental.aspx">View Dental</a>
                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-8">
                                                            <asp:DropDownList ID="ddlCat" CssClass="form-control" runat="server">
                                                                <asp:ListItem Value="1">X-Rays</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="panel panel-default thumbnail">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="panel-body panel-form">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-xs-8">
                                                                <asp:DropDownList ID="ddlConsultant" CssClass="form-control" runat="server">
                                                                    <asp:ListItem Value="1">General Consultant</asp:ListItem>
                                                                </asp:DropDownList>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class="panel-body panel-form">
                                                        <div class="form-group row">
                                                            <label for="TestName" class="col-xs-4 col-form-label">Test Name</label>
                                                            <div class="col-xs-8">
                                                                <asp:DropDownList ID="ddlTestName" CssClass="form-control" runat="server">
                                                                    <asp:ListItem Value="1">Routine Check-up</asp:ListItem>
                                                                    <asp:ListItem Value="2">Teeth Cleaning</asp:ListItem>
                                                                    <asp:ListItem Value="3">Tooth Extraction</asp:ListItem>
                                                                    <asp:ListItem Value="4">Root Canal Treatment</asp:ListItem>
                                                                    <asp:ListItem Value="5">Filling (Cavity)</asp:ListItem>
                                                                    <asp:ListItem Value="6">Crown Placement</asp:ListItem>
                                                                    <asp:ListItem Value="7">Braces Consultation</asp:ListItem>
                                                                    <asp:ListItem Value="8">Dental Implants</asp:ListItem>
                                                                    <asp:ListItem Value="9">Teeth Whitening</asp:ListItem>
                                                                    <asp:ListItem Value="10">Gum Treatment</asp:ListItem>
                                                                    <asp:ListItem Value="11">Dental X-ray</asp:ListItem>
                                                                    <asp:ListItem Value="12">Periodontal Treatment</asp:ListItem>
                                                                    <asp:ListItem Value="13">Fluoride Treatment</asp:ListItem>
                                                                    <asp:ListItem Value="14">Dentures</asp:ListItem>
                                                                    <asp:ListItem Value="15">Smile Design</asp:ListItem>
                                                                    <asp:ListItem Value="16">Pediatric Dentistry</asp:ListItem>
                                                                </asp:DropDownList>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="panel-body panel-form">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-xs-8">
                                                                <asp:TextBox ID="txtRupees" CssClass="form-control text-box single-line" runat="server" TextMode="Number" Text="0" AutoPostBack="true" OnTextChanged="TxtRs_TextChanged"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-xs-8">
                                                                        <asp:TextBox ID="txtSPD" CssClass="form-control text-box single-line" runat="server" TextMode="Number" Text="0"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-xs-8">
                                                                        <asp:TextBox ID="txtZF" CssClass="form-control text-box single-line" runat="server" TextMode="Number" Text="0"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
    ...
    <script type="text/javascript">
        function generatePDF() {
            ...
            var testname = document.getElementById('<%= ddlTestName.ClientID %>').options[document.getElementById('<%= ddlTestName.ClientID %>').selectedIndex].text;
        ...
        function downloadPDF() {
            generatePDF().download('DentalReceipt.pdf');
        }
