<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="EditOP_MedSer.aspx.cs" Inherits="HMS_Task1.EditOP_MedSer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        ...
        <ol class="breadcrumb breadcrumb-new">
            ...
            <li class="active">Medical Services (PROC)</li>
        </ol>
        <!-- Main content -->
        <!-- /.content -->
                            ...
                            <div class="panel panel-bd">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4>Edit Medical Services</h4>
                                    </div>
                                    <div class="mr-25">
                                        <a class="btn btn-primary" href="ViewOP_MedSer.aspx">View Medical Services</a>
                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-8">
                                                            <asp:DropDownList ID="ddlCat" CssClass="form-control" runat="server">
                                                                <asp:ListItem Value="1">Medical Services (PROC)</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-xs-8">
                                                                <asp:DropDownList ID="ddlTestName" CssClass="form-control" runat="server">
                                                                    <asp:ListItem Text="Select Option" />
                                                                    <asp:ListItem Value="1">Emergency Care</asp:ListItem>
                                                                    <asp:ListItem Value="2">Physiotherapy</asp:ListItem>
                                                                    <asp:ListItem Value="3">Immunization</asp:ListItem>
                                                                    <asp:ListItem Value="4">Vaccination</asp:ListItem>
                                                                    <asp:ListItem Value="5">Dialysis</asp:ListItem>
                                                                    <asp:ListItem Value="6">Eye Care</asp:ListItem>
                                                                    <asp:ListItem Value="7">CT Scan</asp:ListItem>
                                                                    <asp:ListItem Value="8">MRI</asp:ListItem>
                                                                    <asp:ListItem Value="9">Cardiology</asp:ListItem>
                                                                    <asp:ListItem Value="10">Orthopedic</asp:ListItem>
                                                                    <asp:ListItem Value="11">Endoscopy</asp:ListItem>
                                                                </asp:DropDownList>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <script type="text/javascript">
        function generatePDF() {
            ...
            var sectionContent = [
                ...
                {
                    text: 'Receipt: Medical Services (PROC)',
                    style: 'subheader',
                    alignment: 'center',
                    margin: [0, 10, 0, 10]
                },
        ...
        function downloadPDF() {
            generatePDF().download('MedicalServicesReceipt.pdf');
        }
