<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="EditOP_Ultrasound.aspx.cs" Inherits="HMS_Task1.EditOP_Ultrasound" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                            ...
                            <div class="panel panel-bd">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4>Edit Ultrasound</h4>
                                    </div>
                                    <div class="mr-25">
                                        <a class="btn btn-primary" href="ViewOP_Ultrasound.aspx">View Ultrasound</a>
                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-8">
                                                            <asp:DropDownList ID="ddlCat" CssClass="form-control" runat="server">
                                                                <asp:ListItem Value="1">Ultrasound</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-xs-8">
                                                                <asp:DropDownList ID="ddlTestName" CssClass="form-control" runat="server">
                                                                    <asp:ListItem Text="Select Option" />
                                                                    <asp:ListItem Value="1">Abdominal Ultrasound</asp:ListItem>
                                                                    <asp:ListItem Value="2">Pelvic Ultrasound</asp:ListItem>
                                                                    <asp:ListItem Value="3">Transvaginal Ultrasound</asp:ListItem>
                                                                    <asp:ListItem Value="4">Obstetric Ultrasound</asp:ListItem>
                                                                    <asp:ListItem Value="5">Renal Ultrasound</asp:ListItem>
                                                                    <asp:ListItem Value="6">Thyroid Ultrasound</asp:ListItem>
                                                                    <asp:ListItem Value="7">Musculoskeletal Ultrasound</asp:ListItem>
                                                                    <asp:ListItem Value="8">Breast Ultrasound</asp:ListItem>
                                                                    <asp:ListItem Value="9">Carotid Ultrasound</asp:ListItem>
                                                                    <asp:ListItem Value="10">Abdominal Aorta Ultrasound</asp:ListItem>
                                                                    <asp:ListItem Value="11">Pediatric Ultrasound</asp:ListItem>
                                                                </asp:DropDownList>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <script type="text/javascript">
        ...
        function downloadPDF() {
            generatePDF().download('UltrasoundReceipt.pdf');
        }
