<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="EditOP_Xray.aspx.cs" Inherits="HMS_Task4.EditOP_Xray" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd">
                                <div class="panel-heading">
                                    ...
                                    <div class="mr-25">
                                        <a class="btn btn-primary" href="ViewOP_Xray.aspx">View X_RAY</a>
                                    </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-xs-8">
                                                                <asp:DropDownList ID="ddlTestName" CssClass="form-control" runat="server">
                                                                    <asp:ListItem Text="Select Option" />
                                                                    <asp:ListItem Value="1">TIBIA & FIBULA A/P LAT RIGHT</asp:ListItem>
                                                                    <asp:ListItem Value="2">CHEST A/P</asp:ListItem>
                                                                    <asp:ListItem Value="3">LUMBAR SPINE A/P LAT</asp:ListItem>
                                                                    <asp:ListItem Value="4">HUMERUS A/P LAT LEFT</asp:ListItem>
                                                                    <asp:ListItem Value="5">FEMUR A/P LAT LEFT</asp:ListItem>
                                                                    <asp:ListItem Value="6">KNEE A/P LAT RIGHT</asp:ListItem>
                                                                    <asp:ListItem Value="7">ELBOW A/P LAT</asp:ListItem>
                                                                    <asp:ListItem Value="8">HAND A/P LAT</asp:ListItem>
                                                                    <asp:ListItem Value="9">ANKLE A/P LAT RIGHT</asp:ListItem>
                                                                    <asp:ListItem Value="10">PELVIS A/P</asp:ListItem>
                                                                    <asp:ListItem Value="11">SKULL A/P LAT</asp:ListItem>
                                                                </asp:DropDownList>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <script type="text/javascript">
        ...
        function downloadPDF() {
            generatePDF().download('XRayReceipt.pdf');
        }
