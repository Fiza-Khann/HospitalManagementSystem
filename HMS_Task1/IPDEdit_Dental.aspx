<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="IPDEdit_Dental.aspx.cs" Inherits="HMS_Task1.IPDEdit_Dental" %>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd">
                                <div class="panel-heading">
                                    ...
                                    <div class="mr-25">
                                        <a class="btn btn-primary" href="IPDView_Dental.aspx">View Dental</a>
                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-8">
                                                            <asp:DropDownList ID="ddlCat" CssClass="form-control" runat="server">
                                                                <asp:ListItem Value="1">Dental</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
