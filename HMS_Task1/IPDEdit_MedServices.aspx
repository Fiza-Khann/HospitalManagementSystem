<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="IPDEdit_MedServices.aspx.cs" Inherits="HMS_Task_5.IPDEdit_MedServices" %>
                            ...
                            <div class="panel panel-bd">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4>Add: Medical Services (PROC)</h4>
                                    </div>
                                    <div class="mr-25">
                                        <a class="btn btn-primary" href="IPDView_MedServices.aspx">View Medical Services</a>
                                    </div>
                                                            ...
                                                            <div class="col-md-9 col-sm-12">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-xs-9">
                                                                        ...
                                                                        <asp:RequiredFieldValidator ID="rfvName" runat="server" ValidationGroup="SaveGroup" ControlToValidate="txtName" ErrorMessage="Name is required" CssClass="error" />
                                                                    </div>
                                                                </div>
                                                                <!-- Charges -->
                                                                <div class="form-group row">
