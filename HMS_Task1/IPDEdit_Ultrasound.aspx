<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="IPDEdit_Ultrasound.aspx.cs" Inherits="HMS_Task_5.IPDEdit_Ultrasound" %>
                            ...
                            <div class="panel panel-bd">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4>Add: Ultrasound \ Doppler</h4>
                                    </div>
                                    <div class="mr-25">
                                        <a class="btn btn-primary" href="IPDView_Ultrasound.aspx">View Ultrasound</a>
                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-8">
                                                            <asp:DropDownList ID="ddlCat" CssClass="form-control" runat="server">
                                                                <asp:ListItem Value="1">Ultrasound / Doppler</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
