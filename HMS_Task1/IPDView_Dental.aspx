<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="IPDView_Dental.aspx.cs" Inherits="HMS_Task1.IPDView_Dental" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="col-sm-12">
                    <div class="panel panel-bd">
                        <div class="panel-heading">
                            ...
                            <div class="mr-25">
                                <a class="btn btn-primary" href="IPDEdit_Dental.aspx">Edit Dental</a>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function downloadPDF() {
            generatePDF().download('DentalReport.pdf');
            closeModal();
        }
    </script>
</asp:Content>