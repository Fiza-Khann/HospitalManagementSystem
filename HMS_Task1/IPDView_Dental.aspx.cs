...
namespace HMS_Task1
{
    public partial class IPDView_Dental : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT * FROM IN_Dental", con))
                    {
        ...
        private void DeleteConsultant(string id)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("DELETE FROM IN_Dental WHERE ID = @ID", conn))
                {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            foreach (GridViewRow row in MainGrid.Rows)
            {
                ...
                if (chkSelect != null && chkSelect.Checked)
                {
                    ...
                    Response.Redirect("IPDEdit_Dental.aspx?originalReceiptNo=" + originalReceiptNo);
                    return;
                }
            }
