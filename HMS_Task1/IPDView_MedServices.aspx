<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="IPDView_MedServices.aspx.cs" Inherits="HMS_Task_5.IPDView_MedServices" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <div class="panel panel-bd">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h4>View: Medical Services (PROC)</h4>
                            </div>
                            <div class="mr-25">
                                <a class="btn btn-primary" href="IPDEdit_MedServices.aspx">Edit Medical Services</a>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function downloadPDF() {
            generatePDF().download('Medical_Services_Report.pdf');
            closeModal();
        }
