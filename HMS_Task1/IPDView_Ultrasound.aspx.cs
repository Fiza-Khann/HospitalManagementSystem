...
{
    public partial class IPDView_Ultrasound : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT * FROM IPD_Ultrasound", con))
                    {
        ...
        private void DeleteConsultant(string id)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("DELETE FROM IPD_Ultrasound WHERE ID = @ID", conn))
                {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            foreach (GridViewRow row in MainGrid.Rows)
            {
                ...
                if (chkSelect != null && chkSelect.Checked)
                {
                    ...
                    Response.Redirect("IPDEdit_Ultrasound.aspx?originalReceiptNo=" + originalReceiptNo);
                    return;
                }
            }
