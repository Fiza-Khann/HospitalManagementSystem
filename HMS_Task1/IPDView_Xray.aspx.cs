...
namespace HMS_Task1
{
    public partial class IPDView_Xray : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT * FROM IN_Xray", con))
                    {
        ...
        private void DeleteConsultant(string id)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("DELETE FROM IN_Xray WHERE ID = @ID", conn))
                {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            foreach (GridViewRow row in MainGrid.Rows)
            {
                ...
                if (chkSelect != null && chkSelect.Checked)
                {
                    ...
                    Response.Redirect("IPDEdit_Xray.aspx?originalReceiptNo=" + originalReceiptNo);
                    return;
                }
            }
