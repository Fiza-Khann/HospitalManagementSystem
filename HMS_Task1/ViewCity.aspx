<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="ViewCity.aspx.cs" Inherits="HMS_Task1.ViewCity" %>
                    ...
                    <div class="panel panel-bd">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h4>View: City List</h4>
                            </div>
                            <div class="mr-25">
                                <a class="btn btn-primary" href="AddCity.aspx">Edit City</a>
                            </div>
                        </div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2aa" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="MainGrid" runat="server" AutoGenerateColumns="False" BackColor="White"
                                        BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" CellPadding="4" DataKeyNames="CityName"
