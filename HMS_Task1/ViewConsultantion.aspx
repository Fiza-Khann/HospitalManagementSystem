<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="ViewConsultantion.aspx.cs" Inherits="HMS_Task1.ViewConsultantion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        ...
        <ol class="breadcrumb breadcrumb-new">
            ...
            <li class="active">Consulation</li>
        </ol>
        <!-- Main content -->
        <div class="content">
                    ...
                    <div class="panel panel-bd">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h4>View Consulation</h4>
                            </div>
                            <div class="mr-25">
                                <a class="btn btn-primary" href="AddConsultantion.aspx">Edit Consulation</a>
                            </div>
                        </div>
                                            ...
                                            <div style="overflow-x: auto;">
                                                <asp:GridView ID="MainGrid" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="ConsultantID" HeaderText="ConsulantID" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="200px" />
