<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="ViewDischarge.aspx.cs" Inherits="HMS_Task1.ViewDischarge" %>
    ...
    <div class="content-wrapper">
        <ol class="breadcrumb breadcrumb-new">
           <li><a href="Home.aspx">Home</a></li>
            <li><a>Setup</a></li>
            <li class="active">Discharge List</li>
        </ol>
                    ...
                    <div class="panel panel-bd">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h4>View: Discharge List</h4>
                            </div>
                                <div class="mr-25">
                                <a class="btn btn-primary" href="AddDischarge.aspx">Discharge Patient</a>
                            </div>
                        </div>
                        <div class="panel-body">
                            ...
                            <asp:UpdatePanel ID="UpdatePanelDischarge" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="MainGrid" runat="server" AutoGenerateColumns="False" BackColor="White"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Num" HeaderText="Patient No" SortExpression="Num" />
                                            <asp:BoundField DataField="PatientName" HeaderText="Patient Name" SortExpression="PatientName" />
                                            <asp:BoundField DataField="Dstatus" HeaderText="Discharge Status" SortExpression="Dstatus" />
                                            <asp:BoundField DataField="Ddate" HeaderText="Discharge Date" SortExpression="Ddate" />
                                            <asp:BoundField DataField="Dtime" HeaderText="Discharge Time" SortExpression="Dtime" />
                                        </Columns>
